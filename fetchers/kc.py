...
def collect():
    trips = main("https://s3.amazonaws.com/kcm-alerts-realtime-prod/tripupdates.pb")
    vehicles = main("https://s3.amazonaws.com/kcm-alerts-realtime-prod/vehiclepositions.pb")

    fm_str = json_format.MessageToJson(trips)
    fm_str2 = json_format.MessageToJson(vehicles)

    write_to_file("data/kc/vehicles.txt", fm_str)
    write_to_file("data/kc/trips.txt", fm_str2)
